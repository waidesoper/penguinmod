 ...
 public class Camp1Structure {
   ...
   private static class FeatureRegisterHandler { @SubscribeEvent
     public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
       Camp1Structure.feature = new Feature<NoneFeatureConfiguration>(NoFeatureConfig.field_236558_a_)
         {
           public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
             ...
             if (random.nextInt(1000000) + 1 <= 500) {
               ...
               for (int a = 0; a < count; a++) {
                 ...
                 Template template = world.func_201672_e().func_184163_y().func_200220_a(new ResourceLocation("penguinmod", "camp1"));
                 if (template == null)
                   return false; 
       ...
       Camp1Structure.configuredFeature = Camp1Structure.feature.func_225566_b_((IFeatureConfig)IFeatureConfig.field_202429_e)
         .func_227228_a_(Placement.field_215022_h.func_227446_a_((IPlacementConfig)IPlacementConfig.field_202468_e));
       event.getRegistry().register(Camp1Structure.feature.setRegistryName("camp_1"));
       Registry.func_218322_a(WorldGenRegistries.field_243653_e, new ResourceLocation("penguinmod:camp_1"), Camp1Structure.configuredFeature);
     } }
...
/* Location:              /home/waide/Downloads/Amazing+Penguins+1.16.5.jar!/pixlux/penguinmod/world/structure/Camp1Structure.class
