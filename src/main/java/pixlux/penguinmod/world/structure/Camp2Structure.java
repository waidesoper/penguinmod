 ...
 public class Camp2Structure {
   ...
   private static class FeatureRegisterHandler { @SubscribeEvent
     public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
       Camp2Structure.feature = new Feature<NoFeatureConfig>(NoFeatureConfig.field_236558_a_)
         {
           public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
             ...
             if (!dimensionCriteria)
               return false; 
             if (random.nextInt(1000000) + 1 <= 600) {
               ...
               for (int a = 0; a < count; a++) {
                 ...
                 Template template = world.func_201672_e().func_184163_y().func_200220_a(new ResourceLocation("penguinmod", "camp2"));
                 if (template == null)
                   return false; 
       ...
       Camp2Structure.configuredFeature = Camp2Structure.feature.func_225566_b_((IFeatureConfig)IFeatureConfig.field_202429_e)
         .func_227228_a_(Placement.field_215022_h.func_227446_a_((IPlacementConfig)IPlacementConfig.field_202468_e));
       event.getRegistry().register(Camp2Structure.feature.setRegistryName("camp_2"));
       Registry.func_218322_a(WorldGenRegistries.field_243653_e, new ResourceLocation("penguinmod:camp_2"), Camp2Structure.configuredFeature);
     } }
...
/* Location:              /home/waide/Downloads/Amazing+Penguins+1.16.5.jar!/pixlux/penguinmod/world/structure/Camp2Structure.class
