...
public class MinipenguinEntity extends PenguinmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			...
			.size(0.3f, 0.4f)).build("minipenguin").setRegistryName("minipenguin");
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16751002, -1, new Item.Properties().group(AmazingpenguinsItemGroup.tab))
