...
public class YelloweyepenguinRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			EntityRenderers.register(YelloweyepenguinEntity.entity, renderManager -> {
	...
	public static class ModelKing_penguin extends EntityModel<Entity> {
		...
		public ModelKing_penguin() {
			...
			body.texOffs(26, 30).addBox(-1.0F, -2.0F, 2.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			body.texOffs(-1, 31).addBox(-1.0F, -1.0F, 3.0F, 2.0F, 0.0F, 1.0F, 0.0F, false);
			...
			head.texOffs(26, 30).addBox(-1.0F, -5.0F, 0.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			head.texOffs(26, 30).addBox(-1.0F, -5.0F, -2.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
