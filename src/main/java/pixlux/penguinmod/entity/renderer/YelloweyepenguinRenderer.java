...
import pixlux.penguinmod.entity.YelloweyepenguinEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class YelloweyepenguinRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(YelloweyepenguinEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelKing_penguin(), 0.3f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("penguinmod:textures/yellow_eye_penguin.png");
					}
				};
			});
		}
	...
	public static class ModelKing_penguin extends EntityModel<Entity> {
		...
		public ModelKing_penguin() {
			...
			body.setTextureOffset(26, 30).addBox(-1.0F, -2.0F, 2.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			...
			head.setTextureOffset(26, 30).addBox(-1.0F, -5.0F, 0.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(26, 30).addBox(-1.0F, -5.0F, -2.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
