...
public class BigpenguinRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BigpenguinEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelrockhopper_penguin(), 0.3f) {
	...
	public static class Modelrockhopper_penguin extends EntityModel<Entity> {
		...
		public Modelrockhopper_penguin() {
			...
			body.setTextureOffset(0, 9).addBox(-3.0F, -8.0F, -2.0F, 3.0F, 3.0F, 4.0F, 0.0F, false);
			body.setTextureOffset(0, 25).addBox(0.0F, -8.0F, -2.0F, 3.0F, 3.0F, 4.0F, 0.0F, false);
			body.setTextureOffset(0, 19).addBox(-3.0F, -3.0F, -2.0F, 6.0F, 2.0F, 4.0F, 0.0F, false);
			body.setTextureOffset(12, 26).addBox(-3.0F, -5.0F, -2.0F, 6.0F, 2.0F, 4.0F, 0.0F, false);
			body.setTextureOffset(26, 28).addBox(-1.0F, -2.0F, 2.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			body.setTextureOffset(-1, 31).addBox(-1.0F, -1.0F, 3.0F, 2.0F, 0.0F, 1.0F, 0.0F, false);
			...
			head.setTextureOffset(6, 10).addBox(-2.0F, -5.0F, -1.0F, 4.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(19, 27).addBox(-1.0F, -5.0F, 0.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(26, 0).addBox(-1.0F, -5.0F, -2.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			...
			leftwing.setTextureOffset(26, 17).addBox(3.0F, -7.0F, -1.0F, 1.0F, 5.0F, 2.0F, 0.0F, false);
			rightwing = new ModelRenderer(this);
			rightwing.setRotationPoint(0.0F, 24.0F, 0.0F);
			rightwing.setTextureOffset(26, 18).addBox(-4.0F, -7.0F, -1.0F, 1.0F, 5.0F, 2.0F, 0.0F, false);
