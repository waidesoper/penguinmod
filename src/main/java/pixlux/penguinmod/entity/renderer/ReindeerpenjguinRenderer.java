...
public class ReindeerpenjguinRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ReindeerpenjguinEntity.entity, renderManager -> {
	...
	public static class Modelfixedbrand_new_reindeerpenguin extends EntityModel<Entity> {
		...
		public Modelfixedbrand_new_reindeerpenguin() {
			...
			body.setTextureOffset(0, 23).addBox(-3.0F, -3.0F, -2.0F, 6.0F, 2.0F, 4.0F, 0.0F, false);
			...
			body.setTextureOffset(25, 24).addBox(-1.0F, -1.0F, 3.0F, 2.0F, 0.0F, 1.0F, 0.0F, false);
			...
			head.setTextureOffset(23, 9).addBox(-1.0F, -5.0F, -2.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(19, 17).addBox(3.0F, -10.0F, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F, false);
			head.setTextureOffset(29, 16).addBox(1.0F, -10.0F, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F, false);
			head.setTextureOffset(28, 15).addBox(-2.0F, -10.0F, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F, false);
			head.setTextureOffset(27, 17).addBox(-4.0F, -10.0F, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F, false);
			head.setTextureOffset(18, 17).addBox(-5.0F, -8.0F, 0.0F, 2.0F, 1.0F, 0.0F, 0.0F, false);
			head.setTextureOffset(22, 19).addBox(3.0F, -8.0F, 0.0F, 2.0F, 1.0F, 0.0F, 0.0F, false);
			head.setTextureOffset(30, 14).addBox(2.0F, -9.0F, 0.0F, 1.0F, 3.0F, 0.0F, 0.0F, false);
			head.setTextureOffset(18, 18).addBox(-3.0F, -9.0F, 0.0F, 1.0F, 3.0F, 0.0F, 0.0F, false);
			head.setTextureOffset(17, 18).addBox(1.0F, -6.0F, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F, false);
			head.setTextureOffset(18, 19).addBox(-2.0F, -6.0F, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F, false);
			head.setTextureOffset(22, 2).addBox(-1.0F, -2.0F, -4.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			...
			rightwing.setTextureOffset(10, 6).addBox(-4.0F, -7.0F, -1.0F, 1.0F, 5.0F, 2.0F, 0.0F, false);
