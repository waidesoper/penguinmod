...
public class MegallanicpenguinRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			EntityRenderers.register(MegallanicpenguinEntity.entity, renderManager -> {
	...
	public static class ModelMagellanic_penguin extends EntityModel<Entity> {
		...
		public ModelMagellanic_penguin() {
			...
			body.texOffs(11, 9).addBox(-1.0F, -2.0F, 2.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			...
			head.texOffs(11, 12).addBox(-1.0F, -5.0F, -2.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			...
			rightwing.texOffs(12, 5).addBox(-4.0F, -7.0F, -1.0F, 1.0F, 5.0F, 2.0F, 0.0F, false);
