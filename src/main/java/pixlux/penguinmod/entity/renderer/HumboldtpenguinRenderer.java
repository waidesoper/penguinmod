...
import pixlux.penguinmod.entity.HumboldtpenguinEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class HumboldtpenguinRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(HumboldtpenguinEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelhumboldt_penguin(), 0.4f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("penguinmod:textures/humboldt_penguin.png");
					}
				};
			});
		}
	...
	public static class Modelhumboldt_penguin extends EntityModel<Entity> {
		...
		public Modelhumboldt_penguin() {
			...
			rightwing.setTextureOffset(26, 0).addBox(-4.0F, -7.0F, -1.0F, 1.0F, 5.0F, 2.0F, 0.0F, false);
