...
public class EarpenguinRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			EntityRenderers.register(EarpenguinEntity.entity, renderManager -> {
	...
	public static class Modelfixedbrand_new_earpenguin extends EntityModel<Entity> {
		...
		public Modelfixedbrand_new_earpenguin() {
			...
			body.texOffs(0, 16).addBox(-3.0F, -8.0F, -2.0F, 6.0F, 3.0F, 4.0F, 0.0F, false);
			body.texOffs(0, 24).addBox(-3.0F, -3.0F, -2.0F, 6.0F, 2.0F, 4.0F, 0.0F, false);
			body.texOffs(0, 24).addBox(-3.0F, -5.0F, -2.0F, 6.0F, 2.0F, 4.0F, 0.0F, false);
			body.texOffs(10, 0).addBox(-1.0F, -2.0F, 2.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			body.texOffs(26, 13).addBox(-1.0F, -1.0F, 3.0F, 2.0F, 0.0F, 1.0F, 0.0F, false);
			head = new ModelPart(this);
			head.setRotationPoint(0.0F, 16.0F, 1.0F);
			head.texOffs(2, 1).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 2.0F, 3.0F, 0.0F, false);
			head.texOffs(18, 27).addBox(-2.0F, -4.0F, -2.0F, 4.0F, 2.0F, 3.0F, 0.0F, false);
			...
			head.texOffs(21, 15).addBox(-1.0F, -5.0F, -2.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			head.texOffs(23, 21).addBox(-1.0F, -2.0F, -4.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			head.texOffs(26, 9).addBox(-2.0F, -6.0F, -1.0F, 0.0F, 1.0F, 1.0F, 0.0F, false);
			head.texOffs(23, 3).addBox(-2.0F, -6.0F, -1.0F, 4.0F, 0.0F, 1.0F, 0.0F, false);
			head.texOffs(23, 6).addBox(2.0F, -6.0F, -1.0F, 0.0F, 1.0F, 1.0F, 0.0F, false);
