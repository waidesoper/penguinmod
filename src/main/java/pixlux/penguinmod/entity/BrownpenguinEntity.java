...
import pixlux.penguinmod.entity.renderer.BrownpenguinRenderer;
import pixlux.penguinmod.PenguinmodModElements;

@PenguinmodModElements.ModElement.Tag
public class BrownpenguinEntity extends PenguinmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.5f, 0.7000000000000001f)).build("brownpenguin").setRegistryName("brownpenguin");

	public BrownpenguinEntity(PenguinmodModElements instance) {
		super(instance, 16);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BrownpenguinRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -1, new Item.Properties().group(AmazingpenguinsItemGroup.tab))
				.setRegistryName("brownpenguin_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.AMBIENT).add(new MobSpawnInfo.Spawners(entity, 17, 4, 7));
	}
