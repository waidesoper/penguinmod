...
public class BrownpenguinEntity extends PenguinmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>of(CustomEntity::new, MobCategory.AMBIENT)
			...
			.sized(0.5f, 0.7000000000000001f)).build("brownpenguin").setRegistryName("brownpenguin");
	...
	public void initElements() {
		...
		elements.items.add(() -> new ForgeSpawnEggItem((Supplier<? extends EntityType<? extends Mob>>) entity, -10079488, -1, new Item.Properties().tab(AmazingpenguinsItemGroup.tab))
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(MobCategory.AMBIENT).add(new MobSpawnSettings.SpawnerData(entity, 17, 4, 7));
	}
