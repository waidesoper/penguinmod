...
import pixlux.penguinmod.entity.renderer.MegallanicpenguinRenderer;
...
public class MegallanicpenguinEntity extends PenguinmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1f))
					.build("megallanicpenguin").setRegistryName("megallanicpenguin");

	public MegallanicpenguinEntity(PenguinmodModElements instance) {
		super(instance, 24);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MegallanicpenguinRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -10066330, new Item.Properties().group(AmazingpenguinsItemGroup.tab))
				.setRegistryName("megallanicpenguin_spawn_egg"));
	}
