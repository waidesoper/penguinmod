...
import pixlux.penguinmod.entity.renderer.DededeRenderer;
...
public class DededeEntity extends PenguinmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1f))
					.build("dedede").setRegistryName("dedede");

	public DededeEntity(PenguinmodModElements instance) {
		super(instance, 30);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DededeRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16724788, -13312, new Item.Properties().group(AmazingpenguinsItemGroup.tab))
				.setRegistryName("dedede_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.AMBIENT).add(new MobSpawnInfo.Spawners(entity, 10, 1, 1));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.add(Attributes.ARMOR, 2);
			ammma = ammma.add(Attributes.ATTACK_DAMAGE, 3);
			ammma = ammma.add(Attributes.ATTACK_KNOCKBACK, 0.1);
