...
import pixlux.penguinmod.entity.renderer.ReindeerpenjguinRenderer;
...
public class ReindeerpenjguinEntity extends PenguinmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1f))
					.build("reindeerpenjguin").setRegistryName("reindeerpenjguin");

	public ReindeerpenjguinEntity(PenguinmodModElements instance) {
		super(instance, 12);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ReindeerpenjguinRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -10079488, new Item.Properties().group(AmazingpenguinsItemGroup.tab))
				.setRegistryName("reindeerpenjguin_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.AMBIENT).add(new MobSpawnInfo.Spawners(entity, 20, 4, 7));
	}
