...
import pixlux.penguinmod.entity.renderer.PenguinRenderer;
...
public class PenguinEntity extends PenguinmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1f))
					.build("penguin").setRegistryName("penguin");

	public PenguinEntity(PenguinmodModElements instance) {
		super(instance, 1);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(AmazingpenguinsItemGroup.tab))
				.setRegistryName("penguin_spawn_egg"));
	}
